...
`ai/docs/prompts/verify/default.md`에 검증 기준이 있습니다.

이 파일은 `bash ai/scripts/verify.sh` 실행 시 Claude CLI에 전달되는 프롬프트입니다.
...
`ai/config/review-tools.json.example`을 `review-tools.json`으로 복사해서 시작하세요.
